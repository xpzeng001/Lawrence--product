...
OUT_DIR = ROOT / "outputs" / "storyboard-curated-full-frames"
PDF_PATH = OUT_DIR / "Lawrence-分镜完整画面_16x9完成态精选版.pdf"

PAGE_W = 1920
PAGE_H = 1080

# 1-based positions in the sorted extracted-frame list.
# Keep only fully composed states; omit blank title beds, fade-ins, and partial entrances.
KEEP_INDEXES = [
    1, 3, 4,
    6, 7, 8,
    11, 12, 14,
...
def main() -> None:
    ...
    pdf.setTitle("Lawrence 分镜完整画面 16x9 完成态精选版")
